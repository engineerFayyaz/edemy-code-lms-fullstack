                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="single-footer-widget">
                            <Link href="/">
                                <a className="logo">
                                    <img src="/images/logo.png" alt="logo" style={{width:"150px",height:"150px",borderRadius:"100px"}} />
                                </a>
                            </Link>
                ...
                <div className="footer-bottom-area">
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6">
                            <p><i className='bx bx-copyright'></i>{currentYear} Toxic Beauty Academy is Proudly Powered by <a target="_blank" href="#">Toxic Beauty LLC.</a></p>
                        </div>
