      ...
      <div className="advisor-area bg-f9f9f9 pt-100">
        <div className="container">
          <div className="section-title">
            ...
            <p>
              Greetings, smile enthusiasts! Join us at Toxic Beauty Academy for
              an exciting Teeth Whitening Course that will equip you with the
              skills and knowledge to brighten the world, one smile at a time.
            </p>
          </div>
            ...
            <SwiperSlide>
              <div className="single-advisor-item">
                ...
                <div className="advisor-content">
                  ...
                  <span>Teeth Scaling Specialist</span>
                </div>
              </div>
            </SwiperSlide>
