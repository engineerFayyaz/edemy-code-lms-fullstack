          ...
          <div className="col-lg-5 col-md-12">
            <div className="about-content-box">
              <span className="sub-title">
                Teeth Whitening Course with Toxic Beauty
              </span>
              <h2>Build Your Skills Online, Anytime</h2>
              <p>
                A teeth whitening course outline typically covers various
                aspects of the teeth whitening process, including theory,
                practical skills, safety procedures, and business aspects. Below
                is a summary of what a typical teeth whitening course .
              </p>
              <p>
                <strong>
